...
- Actions는 5분마다 시작하며, 각 실행에서 약 60초 간격으로 최대 5회 조회합니다. 예약 실행 자체가 늦거나 누락되면 감시 간격도 길어질 수 있습니다.
...
- 예약: 2026년 9월 17~23일에 5분마다 실행. 각 실행은 시작 직후, 이후 약 60초 간격으로 최대 5회 조회하고 보통 약 4분대에 끝납니다. 실행 시간이 길어지면 260초 제한에 맞춰 다음 조회를 생략합니다. 같은 그룹의 workflow는 동시 실행하지 않습니다.
